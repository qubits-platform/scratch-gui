    ...
    <MenuItem onClick={props.onClick}>
      <div className={styles.option}>
        <img
          ...
          src={check}
        />
        <img className={styles.icon} src={themeInfo.icon} />
...
const ThemeMenu = ({ isRtl, menuOpen, onChangeTheme, onRequestOpen, theme }) => {
  const enabledThemes = [DEFAULT_THEME, HIGH_CONTRAST_THEME]
  const themeInfo = themeMap[theme]

  return (
    <MenuItem expanded={menuOpen}>
      <div className={styles.option} onClick={onRequestOpen}>
        <img src={themeInfo.icon} style={{ width: 24 }} />
